  ...
  return (
    <Layout>
      <div className="space-y-6 animate-fade-in">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#333]">Calendrier des webinaires</h1>
          <p className="text-muted-foreground">
            Consultez tous les webinaires programmés pour nos stagiaires.
          </p>
        </div>
          ...
          <Card className="col-span-1 lg:col-span-3">
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="text-[#333]">Calendrier</CardTitle>
